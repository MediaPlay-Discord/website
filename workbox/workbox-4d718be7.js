define("./workbox-4d718be7.js", ["exports"], (function (t) {
    "use strict";
    try {
    ...
    class L {
        constructor(t, e) {
            this.u = {}, Object.assign(this, e), this.event = e.event, this.l = t, this.p = new v, this.g = [], this.R = [...t.plugins], this.m = new Map;
        ...
        async cacheMatch(t) {
            ...
            const {
                cacheName: n,
                matchOptions: i
            } = this.l, r = await this.getCacheKey(e, "read"), o = c({}, i, {
                cacheName: n
            });
        ...
        async cachePut(t, e) {
            ...
            const {
                cacheName: h,
                matchOptions: u
            } = this.l, l = await self.caches.open(h), f = this.hasCallback("cacheDidUpdate"), w = f ? await async function (t, e, s, n) {
                const i = m(e.url, s);
            ...
            }(l, r.clone(), ["__WB_REVISION__"], u): null;
            try {
        ...
        async getCacheKey(t, e) {
            if (!this.u[e]) {
                let s = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) s = U(await t({
                    mode: e,
                    request: s,
                    event: this.event,
                    params: this.params
    ...
    class b extends class {
        ...
        constructor(t = {}) {
            t.cacheName = l(t.cacheName), super(t), this._ = !1 !== t.fallbackToNetwork, this.plugins.push(b.copyRedirectedCacheableResponsesPlugin)
        }
        async L(t, e) {
    ...
    class C {
        ...
        createHandlerBoundToURL(t) {
            ...
            return s => (s.request = new Request(t), s.params = c({
                cacheKey: e
...
//# sourceMappingURL=workbox-4d718be7.js.map